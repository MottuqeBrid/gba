...
export default function Page() {
  ...
  const members = [
    ...
    },
    {
      ...
      photo:
        "https://ui-avatars.com/api/?name=James+Smith&background=0ea5e9&color=fff",
      status: "Active",
    ...
    },
    {
      ...
      position: "Treasurer",
      photo:
        "https://ui-avatars.com/api/?name=Emily+Davis&background=0ea5e9&color=fff",
      status: "Active",
    ...
    // Adding more mock members for pagination testing
    ...Array.from({ length: 15 }).map((_, i) => ({
      id: i + 5,
      fullName: `Member ${i + 1}`,
      email: `member${i + 1}@example.com`,
      discipline: ["Economics", "Physics", "Chemistry", "Arts"][i % 4],
      position: "Member",
      photo: `https://ui-avatars.com/api/?name=Member+${i + 1}&background=random`,
